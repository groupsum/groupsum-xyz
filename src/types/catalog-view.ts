...
export type CatalogEvidence = { kind?: string; url?: string; observed_at?: string };
...
export type CatalogViewRecord = {
  ...
  evidence?: CatalogEvidence[]; legal_evidence?: unknown[]; ssot_governance?: Record<string, unknown>;
  ...
  evidence_type?: string; path?: string; visibility?: string; default_branch?: string;
