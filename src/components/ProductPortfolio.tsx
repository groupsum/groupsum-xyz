...
type CatalogPackage = PackageResource & { display_name?: string; route?: string };
...
function catalogBundle(model: ProductPageModel): ProductCatalogBundle {
...
function repositorySignals(repository: RepositoryResource): RepositorySignals {
  return {
    repository_count: 1,
    metrics: {
