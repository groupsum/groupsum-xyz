...
export function ExplorerSolutionDetailPage({ slug, onNavigate }: { slug: string; onNavigate: Navigate }) {
  ...
  return <div className="mx-auto max-w-[var(--content-max)] space-y-8 px-4 py-10 sm:px-6 lg:px-8">
    ...
    ]} actions={<button type="button" onClick={() => onNavigate("/contact")} className="inline-flex min-h-10 items-center gap-1.5 rounded-lg bg-ink px-4 font-mono text-xs font-semibold text-white hover:bg-accent">{solution.cta} <ArrowRight className="h-3.5 w-3.5" /></button>} />
...
export function ExplorerServiceDetailPage({ slug, onNavigate }: { slug: string; onNavigate: Navigate }) {
  ...
  return <div className="mx-auto max-w-[var(--content-max)] space-y-8 px-4 py-10 sm:px-6 lg:px-8">
    ...
    ]} actions={<button type="button" onClick={() => onNavigate("/contact")} className="inline-flex min-h-10 items-center gap-1.5 rounded-lg bg-ink px-4 font-mono text-xs font-semibold text-white hover:bg-accent">{service.cta} <ArrowRight className="h-3.5 w-3.5" /></button>} />
...
export function ExplorerAboutPage({ onNavigate }: { onNavigate: Navigate }) {
  ...
  return <div className="mx-auto max-w-[var(--content-max)] space-y-8 px-4 py-10 sm:px-6 lg:px-8">
    ...
    ]} actions={<button type="button" onClick={() => onNavigate("/contact")} className="inline-flex min-h-10 items-center gap-1.5 rounded-lg bg-ink px-4 font-mono text-xs font-semibold text-white hover:bg-accent">Discuss a project <ArrowRight className="h-3.5 w-3.5" /></button>} />
