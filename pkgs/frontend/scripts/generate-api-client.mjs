...
const schemaTarget = process.env.GROUPSUM_API_SCHEMA_OUTPUT || "pkgs/frontend/src/api/schema.generated.ts";
const contractTarget = process.env.GROUPSUM_API_CONTRACT_OUTPUT || "pkgs/frontend/src/api/contract.generated.ts";
