...
const activeContentFiles = [
  ...
  "pkgs/frontend/src/components/SiteFooter.tsx",
  "pkgs/frontend/src/data/entities.ts",
  "pkgs/frontend/src/data/portfolio.ts",
...
const evidenceFile = fs.readFileSync("pkgs/frontend/src/data/entities.ts", "utf8");
