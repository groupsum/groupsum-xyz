...
class ImplementationSampleApplication(CatalogTable):
    __tablename__ = "resource_implementation_sample_application"
    ENTITY_TYPE = "implementation.sample_application"
