...
class OfferingSolution(CatalogTable):
    __tablename__ = "resource_offering_solution"
    ENTITY_TYPE = "offering.solution"

    id = Column(String(360), primary_key=True)
    slug = Column(String(240), nullable=False, unique=True, index=True)
